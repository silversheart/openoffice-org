type=page
title=Переваги офісного пакету
...
- Усі застосунки мають схожий "вигляд і відчуття", що робить їх дуже простими у використанні,
  ...
  комп'ютера - якщо ви зміните ваш робочий стіл, Apache OpenOffice зміниться відповідно.
...
- Вам не потрібно знати, в якому застосунку створений той чи інший файл - 
  ви можете вибрати "Відкрити файл" з будь-якого Apache OpenOffice, з
  будь-якого місця і буде запущений потрібний застосунок.

- Усі застосунки мають загальне налаштування, наприклад перевірки орфографії;
...
- Всі застосунки випущені зі тією самою відкритою моделлю ліцензування - немає
